...
public class CommonUtilities {
        ...
        public static <Screenshot> String takeScreenShotWebReturnPath(WebDriver driver, String ClassName) throws IOException {
        ...
        public <JSONObject> JSONObject ReadJsonFileGetJsonObject(String sPathOfJson) throws Exception {
        ...
        public <JSONObject> JSONObject convertStringToJsonObject(String sJsonContent) throws Exception {
            JSONObject jsonObject = new JSONObject();
            try {
